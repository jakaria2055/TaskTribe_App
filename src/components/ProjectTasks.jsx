      ...
      <div className="flex flex-wrap gap-4 mb-4">
        {["status", "type", "priority", "assignee"].map((name) => {
          ...
          return (
            <select
              ...
              className=" border not-dark:bg-white border-zinc-300 dark:border-zinc-800 outline-none px-3 py-1 rounded text-sm text-zinc-900 dark:text-zinc-200 dark:bg-zinc-800"
            >
        ...
        {selectedTasks.length > 0 && (
          <button
            ...
            className="px-3 py-1 flex items-center gap-2 rounded bg-gradient-to-br from-pink-400 to-red-600 text-zinc-100 dark:text-zinc-200 text-sm transition-colors"
          >
                      ...
                      >
                        ...
                        >
                          <select
                            ...
                            value={task.status}
                            className="group-hover:ring ring-zinc-100 outline-none px-2 pr-4 py-1 rounded text-sm text-zinc-900 dark:text-zinc-200 cursor-pointer dark:bg-zinc-900"
                          >
